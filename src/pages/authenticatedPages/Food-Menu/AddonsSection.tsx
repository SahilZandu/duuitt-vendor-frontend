...
// export default function AddonsSection({ addons, setAddons, required = false, errors, setErrors }: AddonsSectionProps) {
...
//     const clearError = (
//         groupId: number,
//         field: "group" | "max_selection" | "addon",
//         addonId?: number,
//         addonField?: "name" | "price"
//     ) => {
//         if (!setErrors) return;
//         setErrors(prev => {
...
//             if (field === "addon" && addonId && addonField) {
//                 if (newGroupErrors.addon?.[addonId]) {
//                     const { [addonField]: _, ...rest } = newGroupErrors.addon[addonId];
//                     newGroupErrors.addon = { ...newGroupErrors.addon, [addonId]: rest };
//                     if (Object.keys(newGroupErrors.addon[addonId]).length === 0) {
//                         delete newGroupErrors.addon[addonId];
//                     }
//                 }
//             } else {
...
//             if (
//                 !newGroupErrors.group &&
//                 !newGroupErrors.max_selection &&
//                 (!newGroupErrors.addon || Object.keys(newGroupErrors.addon).length === 0)
//             ) {
//                 const { [groupId]: _, ...rest } = prev;
//                 return rest;
//             }

//             return { ...prev, [groupId]: newGroupErrors };
//         });
//     };
...
//                                     clearError(group.id, "addon", value.id, "name"); // 👈 clears only this field
//                                 }} />
...
//                                         clearError(group.id, "addon", value.id, "price"); // 👈 clears only price error
//                                     }} />
//                             )}
//                             {index !== 0 && (
...
//                             clearError(group.id, "max selection");
//                         }}
//                     />
