...
const Footer = () => {
  ...
  // Routes where full footer is shown
  const showFullFooterRoutes = ["/", "/register", "/vendor-kyc"];
  const showFullFooter = showFullFooterRoutes.includes(location.pathname);
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-3">
                {["f", "i", "t", "x"].map((icon, index) => (
                  <div
                    key={index}
                    className="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center hover:bg-purple-500 cursor-pointer"
                  >
